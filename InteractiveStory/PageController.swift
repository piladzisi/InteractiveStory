...
class PageController: UIViewController {
    ...
    lazy var firstChoiceButton: UIButton = {
        ...
        let selector  = self.page?.firstChoice != nil ? #selector(PageController.loadFirstChoice) : #selector(PageController.playAgain) //ternary operator first check if not nil, after ? provide True case, after : False case
